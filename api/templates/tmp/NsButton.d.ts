...
import type { NsButton } from '@uxda/nutshell'
...
export type ComponentProps = Props<NsButton>
export type ComponentEvents = Events<NsButton>
...
export type ComponentSlots = Slots<NsButton>
...
export type ComponentExposed = ExtractExposed<NsButton['$options']['setup']>
