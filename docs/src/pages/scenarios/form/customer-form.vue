<template>
  <ns-page class="customer-list">
    ...
    <div style="margin-bottom: 10px;">
      <ns-button color="primary" variant="outlined" @click="handleAdd">新增意向客户</ns-button>
    </div>
    ...
    <customer-form-dialog ref="customerFormDialogRef" />
  </ns-page>
</template>
...
import { NsDateRangeInput, NsChips, type CryptoSecret, type TableFilterHandler } from '@uxda/nutshell'
import CustomerFormDialog from './customer-form-dialog.vue'
