<template>
  <ns-page class="filter-page" fill="background">
    <ns-page-header curved
      fill="#C8DAFC"
      title="收益" has-back-button>
    </ns-page-header>
    <ns-page-content>
      <ns-card class="balance-card relative"
        fill="#ffffff90"
        :blur="40"
        shadow>
        <ns-row justify="between" align="end">
          <ns-number :value="累积收益"
            header="累积收益(元)"
            :minimum-fraction-digits="1"
            :maxmimum-fraction-digits="2" />
        </ns-row>
        <template #footer>
          <ns-row justify="around" :gap="10">
            <ns-number :value="今日收益"
              size="xs"
              header="今日收益(元)"
              :minimum-fraction-digits="1"
              :maxmimum-fraction-digits="2" />
            <ns-number :value="本月收益"
              size="xs"
              header="本月收益(元)"
              :minimum-fraction-digits="1"
              :maxmimum-fraction-digits="2" />
            <ns-number :value="上月收益"
              size="xs"
              header="上月收益(元)"
              :minimum-fraction-digits="1"
              :maxmimum-fraction-digits="2" />
      ...
      <ns-row justify="start" :gap="10">
        <h2 class="section-title b">业绩统计</h2>
